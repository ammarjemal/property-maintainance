...
const ToastMessage = (props) => {
    ...
    return (
        <div className='z-50 flex fixed left-[3%] bottom-0 w-80 bg-gray-800'>
            <Transition
                show={showToast}
                enter="transition-translate duration-3000"
                enterFrom="-translate-x-6"
                enterTo="translate-x-6"
                leave="transition-translate duration-3000"
                leaveFrom="-translate-x-6"
